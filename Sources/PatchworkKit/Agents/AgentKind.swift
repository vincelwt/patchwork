...
/// One coding agent Patchwork can drive. Every agent is a peer: Pi has no privileged path
...
public enum AgentKind: String, Codable, Hashable, Sendable, CaseIterable, Identifiable {
    ...
    /// Decoding an agent Patchwork does not know must not fail a whole thread list; unknown
