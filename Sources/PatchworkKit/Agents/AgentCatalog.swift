...
/// Everything Patchwork needs to find, launch, and read one agent.
...
public enum AgentCatalog {
    public static let descriptors: [AgentDescriptor] = [
        AgentDescriptor(
            kind: .pi,
            executableNames: ["pi"],
            executableOverrideKey: "PATCHWORK_PI_PATH",
        ...
        AgentDescriptor(
            ...
            executableOverrideKey: "PATCHWORK_CODEX_PATH",
            sessionRootOverrideKey: "PATCHWORK_CODEX_SESSION_DIR",
        ...
        AgentDescriptor(
            ...
            executableOverrideKey: "PATCHWORK_CLAUDE_PATH",
            sessionRootOverrideKey: "PATCHWORK_CLAUDE_SESSION_DIR",
