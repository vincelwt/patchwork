...
/// Minimal blocking POSIX socket helpers behind `PatchworkClient`. `URLSession` cannot open a Unix
...
/// accepted connection — `PatchworkDaemon`'s `HTTPServer` reuses exactly these for its own sockets
