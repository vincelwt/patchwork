...
public struct CreateThreadRequest: Codable, Sendable {
    ...
    public var agent: AgentKind?
    /// True for a Patchwork remote surface. The daemon records the created session in its own
...
public struct CreateThreadResponse: Codable, Equatable, Sendable {
    ...
    public init(thread: PatchworkThread, runId: String? = nil, firstMessageError: String? = nil) {
        self.thread = thread
        self.runId = runId
