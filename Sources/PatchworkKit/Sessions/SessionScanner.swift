...
/// Locates session files on disk for every agent Patchwork can read. Ported from the app's
/// `FileSessionRepository` (`Sources/Patchwork/SessionRepository.swift`, not importable from
