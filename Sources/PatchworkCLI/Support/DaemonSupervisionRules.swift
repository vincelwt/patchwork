...
/// Pure classification behind `patchwork daemon status`: the default owner is the Patchwork
...
/// Written by Patchwork.app while it hosts the service in-process, so `patchwork daemon status`
...
enum DaemonOwnership {
    static func fileURL(supportDirectory: URL = PatchworkPaths.supportDirectory) -> URL {
