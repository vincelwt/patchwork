...
enum ScheduleCommand {
    ...
    private static let addHelp = CommandHelp(
        usage: "patchwork schedule add --name NAME (--thread ID | --cwd DIR) --prompt TEXT (--at ISO | --every DUR | --cron EXPR | --heartbeat DUR) [options]",
    ...
    private static let runHelp = CommandHelp(
        usage: "patchwork schedule run <id> [--json]",
