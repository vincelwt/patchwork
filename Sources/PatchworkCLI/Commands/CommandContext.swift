...
struct CLIHost {
    ...
    var logFilePath: URL
    /// Where Patchwork.app records that *it* started the currently-running `patchworkd`, if it
    ...
    static func live() -> CLIHost {
        CLIHost(
            ...
            daemonSettingsPath: PatchworkPaths.daemonSettings,
            tokenFilePath: PatchworkPaths.tokenFile,
            logFilePath: PatchworkPaths.logFile,
