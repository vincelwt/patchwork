...
/// `~/Library/Caches/Pi Desktop/favicons/`, per-host in-flight de-duplication, and a small
...
actor FaviconService {
    ...
    static func defaultCacheDirectory() -> URL {
        ...
        return base.appendingPathComponent("Pi Desktop/favicons", isDirectory: true)
    }
