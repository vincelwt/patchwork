...
/// `LimitsWindow` already exist as AppKit-facing view models in `Sources/PiDesktop`, so this
...
public enum LimitsTextParser {
    ...
    private static func window(label: String, value: String) -> LimitsWindowData {
        ...
        return LimitsWindowData(
            label: label.replacingOccurrences(of: "_", with: " ").capitalizedFirstWordPiDesk,
...
private extension String {
    ...
    var capitalizedFirstWordPiDesk: String {
