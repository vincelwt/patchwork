...
/// own `PiLocator` (`Sources/PiDesktop/PiRPCClient.swift`, not importable from here since
/// `PiDesktop` is an app target, not a library) — same override, same search order, same PATH/
