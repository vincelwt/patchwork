...
enum ScheduleCommand {
    ...
    private static let addHelp = CommandHelp(
        usage: "pidesk schedule add --name NAME (--thread ID | --cwd DIR) --prompt TEXT (--at ISO | --every DUR | --cron EXPR | --heartbeat DUR) [--agent AGENT] [--client-id ID] [options]",
    ...
    private static let runHelp = CommandHelp(
        usage: "pidesk schedule run <id> [--client-id ID] [--json]",
