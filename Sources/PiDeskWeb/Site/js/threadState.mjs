...
const DEFAULT_STORAGE_KEY = "pi-desktop-thread-view-state-v1";
...
function availableBrowserStorage() {
  ...
  try {
    if (globalThis.localStorage) {
      globalThis.localStorage.setItem("pi-desktop-storage-check", "1");
      globalThis.localStorage.removeItem("pi-desktop-storage-check");
