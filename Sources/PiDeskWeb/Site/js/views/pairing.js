...
function paint(container, pairing) {
  ...
  if (phase === "pending") {
    mount(container, [
      ...
      h("p", { class: "muted" }, "Keep this page open while you approve the device in Pi Desktop.")
    ]);
    ...
    mount(container, [
      h("p", null, "Open Pi Desktop on your Mac and click the phone button in the sidebar."),
    ...
    mount(container, [
      ...
      h("p", { class: "muted" }, "Generate a new code in Pi Desktop and scan it again.")
    ]);
  } else {
