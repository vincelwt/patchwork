...
struct ConversationScrollMetrics: Equatable {
    ...
    var isNearBottom: Bool {
        documentHeight - (originY + viewportHeight) <= PatchworkTheme.transcriptScrollEdgeThreshold
    }
}
...
struct ConversationScrollObserver: NSViewRepresentable {
    ...
    final class Coordinator: NSObject {
        ...
        private func handleBoundsChange() {
            ...
            pinned = document.bounds.height - (originY + visible.height) <= PatchworkTheme.transcriptScrollEdgeThreshold
            publish()
        }
