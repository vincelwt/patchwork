...
/// `agent_settled` (or Patchwork's command-only completion marker), then stops the runtime.
...
struct PiProcessRunExecutor: RunExecuting {
    ...
    private static let commandOnlyReviewPrompt = "/patchwork-pr-review "
    private static let commandOnlyReviewStatus = "patchwork-pr-review-complete"
