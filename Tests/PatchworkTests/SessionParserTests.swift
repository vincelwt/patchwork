...
final class SessionParserTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        temporaryDirectory = FileManager.default.temporaryDirectory
            .appendingPathComponent("PatchworkTests-\(UUID().uuidString)", isDirectory: true)
    ...
    func testExplicitlyHiddenCustomMessagesStayOutOfTheTranscript() throws {
        XCTAssertNil(SessionParser.chatMessage(fromAgentMessage: .object([
            "role": .string("custom"),
            "customType": .string("patchwork-connectivity-resume"),
        ...
        try write(lines: [
            ...
            ["type": "custom_message", "id": "resume", "parentId": "user",
             "customType": "patchwork-connectivity-resume", "content": "continue", "display": false],
    ...
    func testRetainedPreviewIsBounded() throws {
        ...
        XCTAssertLessThanOrEqual(summary.preview.count, PatchworkTheme.sessionPreviewLimit)
    ...
    func testPagingProjectsHugeKnownAndUnknownPayloadsWithinExplicitBounds() throws {
        ...
        XCTAssertLessThanOrEqual(page.messages[1].raw.stringValue?.count ?? .max, PatchworkTheme.unknownPayloadLimit + 2)
